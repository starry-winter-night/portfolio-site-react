...
const about = ({ sectionRefs, FontAwesome }) => (
  <section id="about" className={`${styles.about} section`} ref={sectionRefs}>
    <div className={styles.title}>
      <h1>About me</h1>
    </div>
    <p>
      안녕하세요. 현재 대전에 거주하는 업력 1년 차 주니어 웹 개발자입니다. 운이
      좋게도 첫 회사에서 PL로서 Front·back-end를 모두 접하며 설계 및 제작을
      경험할 수 있었고 다양한 분야의 개발자분들과 많은 걸 배우고 경험하며 즐겁게
      일할 수 있었습니다. 다만 웹 개발자는 저와 동기뿐이었고 사수 또는
      코드리뷰가 없는 환경이었습니다. 업무에는 차질이 없었지만, 자신의 코드에
      대한 의문과 갈증이 항상 있었고 퇴사 후에 바로 재취업하기보단 자신의 갈증을
      채우기 위해 공부하였습니다. 현재 개발에 대한 열정이 가득 차 있습니다.
      서울에 상경하여 좋은 사람들과 멋지고 많은 경험을 하며 성장하고 싶습니다.
    </p>
